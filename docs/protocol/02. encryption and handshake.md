...
## 4. Secondary Socket Authentication
*(Source Reference: `App/Core/Clipboard.cs`)*

Secondary TCP sockets (such as the Clipboard or Drag-and-Drop file transfer sockets) connect on the same port but **do not** use the 64-byte mutual Handshake Challenge mechanism.
